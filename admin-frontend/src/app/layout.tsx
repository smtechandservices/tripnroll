...
import { LayoutDashboard, Plane, Calendar, LogOut } from 'lucide-react';
import './globals.css';
      ...
      <body>
        <div className="flex min-h-screen bg-slate-100">
          ...
          <aside className="w-64 bg-slate-900 text-white fixed h-full z-20">
            <div className="p-6">
              <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-200 to-emerald-400">
                Trip N Roll Admin
              </h1>
            </div>
